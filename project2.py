...
if __name__ == '__main__':
    ...
    if data_ana:
        ...
        for label in unique_labels:
            ...
            values[label]=sub_df_train['label'].count() #il dataset non è bilanciato --> K fold validation !!
    ...
    df_train['_c_pkts_reor'].value_counts() #quasi tutti zero, secondo andrea dovrebbero essere molto correlati con ooo perche pacchetti disordinati vengono riordinati. Secondo Luca non è cosi perche non è detto che vengano riordinati, possono anche essere ritrasmessi
    ...
    plt.grid()
    plt.show() #la distribuzione viene strana, forse ci sono degli outliers 
    ...
    #c = c[c['Standardized Fwd Packet Length'] > 0]
    ...
    # !!!!! Nel report fare confronto tra modello standardizzato e non
